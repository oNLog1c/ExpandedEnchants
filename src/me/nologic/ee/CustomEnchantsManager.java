...
public class CustomEnchantsManager {
	...
	public static final Enchantment DEFLECT = new DeflectEnchantment("ee_deflect", LanguageManager.instance.GetTranslatedValue("deflect-name"), 5);
